...
export default async function Page() {
  ...
  return <>
    ...
    <main id="conteudo">
      ...
      <section className="border-t border-line bg-paper"><div className="mx-auto max-w-5xl px-5 py-14"><p className="eyebrow">Ficha do projeto</p><dl className="mt-6 grid gap-6 text-sm sm:grid-cols-2 lg:grid-cols-4"><div><dt className="font-bold">Iniciativa</dt><dd className="mt-1 text-muted">Curso Técnico em Informática</dd></div><div><dt className="font-bold">Território</dt><dd className="mt-1 text-muted">Itaberaba · Piemonte do Paraguaçu · Bahia</dd></div><div><dt className="font-bold">Orientação</dt><dd className="mt-1 text-muted">Anderson Ferreira da Silva Pereira</dd></div><div><dt className="font-bold">Natureza</dt><dd className="mt-1 text-muted">Protótipo acadêmico funcional · 2026</dd></div></dl></div></section>
    </main>
